...
object ListOperation {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(88); 
	 ...
	 println("List with pattern matching");$skip(273); 
	 ...
	 };System.out.println("""matchList: [T](lst: List[T])Unit""")}
